def Base_perc(sequence):
    ...
    genetic_code = genetic_code_raw.upper()
    ...
    G_C = str((round((C_base / Total)*100)) + (round((G_base / Total)*100)))
    A_T = str((round((A_base / Total)*100)) + (round((T_base / Total)*100)))
    ...
    Base_perc("AGTAGCTAGCTAGTCGACTGATCGAC")